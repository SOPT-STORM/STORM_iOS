...
class ScrapCardMemoViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        cardView.dropShadow(color: .black, offSet: CGSize(width: 0, height: 3))
        memoView.setRadius(radius: 15)
        memoView.dropShadow(color: .black, offSet: CGSize(width: 0, height: 3))
        setNavigationBar()
